        ...
        while remaining > 0 {
            ...
            'opcodes: {
                ...
                match op & 0xFFFF {
                    ...
                    0x00FE if _args.target != Target::Chip => {
                        // 00FE - LOW
                    ...
                    0x00FF if _args.target != Target::Chip => {
                        // 00FF - HIGH
                    ...
                    0xF000 if _args.target == Target::XO => {
                        // F000
                ...
                match op & 0xF0FF {
                    ...
                    0xF029 => {
                        ...
                        r_i = (r_v[_x] & 0xF) as usize * 5;
                    }
                    0xF030 if _args.target != Target::Chip => {
                        // Fx30
                        // Set I = location of 10-line sprite for digit Vx.
                        r_i = SMALL_FONT_SET.len() + (r_v[_x] & 0xF) as usize * 10;
                    }
                    0xF033 => {
                        // Fx33 - LD B, Vx
                ...
                match op & 0xF00F {
                    ...
                    0x5002 if _args.target == Target::XO => {
                        // 5xy2
                    ...
                    0x5003 if _args.target == Target::XO => {
                        // 5xy3
